import { BadRequestException, Body, ConflictException, Controller, Get, HttpCode, Param, Post, Query, UsePipes } from "@nestjs/common";
...
export class OwnerController {
    constructor(private createOwner: CreateOwnerUseCase, private getOwnerByEmail: GetOwnerByEmailUseCase ){}
    @Get()
    @HttpCode(200)

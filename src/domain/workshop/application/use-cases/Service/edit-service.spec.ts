...
describe("Edit Service", () => {
    beforeEach(() => {
        ...
        sut = new EditServiceUseCase(inMemoryServicesRepository,inMemoryServiceProductsRepository)
    })
    ...
    it("Should be able to edit a service", async () => {
        ...
        expect(inMemoryServicesRepository.items[0].products.currentItems).toHaveLength(2)

...
describe("Fetch recent automobiles", () => {
    ...
    it("Should be able to fetch recent automobiles", async () => {
        await inMemoryAutomobilesRepository.create(makeAutomobile({createdAt: new Date(2022,0,20)}))
        await inMemoryAutomobilesRepository.create(makeAutomobile({createdAt: new Date(2022,0,18)}))
        await inMemoryAutomobilesRepository.create(makeAutomobile({createdAt: new Date(2022,0,23)}))

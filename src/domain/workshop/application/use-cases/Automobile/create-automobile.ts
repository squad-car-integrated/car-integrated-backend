...
type CreateAutomobileUseCaseResponse = Either<null, {
...
export class CreateAutomobileUseCase { 
    ...
    async execute({model, brand, plate,ownerId}: CreateAutomobileUseCaseRequest) : Promise<CreateAutomobileUseCaseResponse> {

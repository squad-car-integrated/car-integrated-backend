...
type DeleteAutomobileUseCaseResponse = Either<ResourceNotFoundError | NotAllowedError ,{}>
export class DeleteAutomobileUseCase { 
    constructor(
        private automobileRepository: AutomobilesRepository,
    ){}
    async execute({automobileId}: DeleteAutomobileUseCaseRequest) : Promise<DeleteAutomobileUseCaseResponse> {
